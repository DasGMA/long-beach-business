        ...
        <Grid container direction='column' alignContent='center' className={classes.footer}>
            <Paper className={classes.paper}>
                <Grid container justify='center'>
                    <Grid container direction='column' sm={3} className={classes.grid} alignItems='flex-start'>
                    ...
                    <Grid container direction='column' sm={3} className={classes.grid} alignItems='flex-start'>
                        <Typography variant='h5' component='h1'>For Business Owners </Typography>
                        <Link variant='body1' component={NavLink} to='/claim-business'>Claim Business</Link>
                        <Link variant='body1' component={NavLink} to='/advertise'>Advertise On LBO</Link>
